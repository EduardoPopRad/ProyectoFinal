...
public class RespuestaException extends Exception {
	...
	/*
	 * Se llaman asi: 
	 * throw new RespuestaException(e.getMessage(), RespuestaException.ERROR_BUSQUEDA, "RespuestaDao");
	 */
	...
	public RespuestaException() {
		super("Ha ocurrido un error relacionado con la Respuesta.");
		this.codigoError = -1;
		this.nombreClase = "";
	}

	public RespuestaException(String mensaje, long codigoError, String nombreClase) {
		super(mensaje);
	...
	public RespuestaException(String mensaje, long codigoError, String nombreClase, Throwable causa) {
		super(mensaje, causa);
		this.codigoError = codigoError;
		this.nombreClase = nombreClase;
	}
	...
	public String getDescripcionError() {
		...
		case (int) ERROR_INSERCION:
			return "Error durante la insercion de la Respuesta en la BBDD.";
		case (int) ERROR_ACTUALIZACION:
			return "Error durante la actualización de la Respuesta en la BBDD.";
		case (int) ERROR_ELIMINACION:
			return "Error durante la eliminación de la Respuesta en la BBDD.";
		case (int) ERROR_BUSQUEDA:
			return "Error durante la búsqueda de la Respuesta en la BBDD.";
		case (int) ERROR_OTRO:
