...
public class ConsultaException extends Exception {
	...
	public static final long ERROR_OBTENCION_NO_RESPONDIDAS = 4;
	public static final long ERROR_CONSULTAR_RESPONDIDA = 5;
	...
	public ConsultaException() {
		super("Ha ocurrido un error relacionado con la Consulta.");
		this.codigoError = -1;
		this.nombreClase = "";
	}

	public ConsultaException(String mensaje, long codigoError, String nombreClase) {
		super(mensaje);
	...
	public ConsultaException(String mensaje, long codigoError, String nombreClase, Throwable causa) {
		super(mensaje, causa);
		this.codigoError = codigoError;
		this.nombreClase = nombreClase;
	}
	...
	public String getDescripcionError() {
		...
		case (int) ERROR_INSERCION:
			return "Error durante la insercion de la Consulta en la BBDD.";
		case (int) ERROR_ACTUALIZACION:
			return "Error durante la actualización de la Consulta en la BBDD.";
		case (int) ERROR_ELIMINACION:
			return "Error durante la eliminación de la Consulta en la BBDD.";
		case (int) ERROR_BUSQUEDA:
			return "Error durante la búsqueda de la Consulta en la BBDD.";
		case (int) ERROR_OBTENCION_NO_RESPONDIDAS:
			return "Error durante la obtención de la calificación de la Consulta.";
        case (int) ERROR_CONSULTAR_RESPONDIDA:
        	return "Error durante la obtención de la media de la Consulta.";
		case (int) ERROR_OTRO:
